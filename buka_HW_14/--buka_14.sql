-- SQLite
-- CREATE TABLE departments(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,name text);
-- CREATE TABLE employee(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,name text,department_id INTEGER,role text, manager_id INTEGER,FOREIGN KEY (department_id) REFERENCES departments(id));
-- 
